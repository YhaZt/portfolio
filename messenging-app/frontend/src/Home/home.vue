...
<template>
  ...
  >
    <div class="flex w-full flex-wrap items-center justify-between px-3">
      ...
      <!-- Center elements -->
      <ul
        class="list-style-none mx-auto hidden flex-row pl-0 md:flex"
      ...
      <!-- Right elements -->
      <ul
        class="list-style-none ml-auto flex flex-row pl-0 md:pl-4"
        data-te-navbar-nav-ref
      >
        <li class="px-2" data-te-nav-item-ref>
          <a
            ...
            ><img
              ...
              loading="lazy"
            />
            <strong class="ml-1 hidden sm:block">{{ Username }}</strong>
          </a>
        </li>
